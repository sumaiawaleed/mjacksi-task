...
<head>
    ...
    <title>:: My-Task:: @lang('site.login')</title>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                        <div style="max-width: 25rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900 text-center">My-Task</h2>
                            </div>
                            <!-- Image block -->
                            <div class="">
                            </div>
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            <!-- Form -->
                            <form class="row g-1 p-3 p-md-4" method="post" action="{{ route('admin-login') }}">
                                @csrf
...
{{--                                                <a class="text-secondary" href="auth-password-reset.html">Forgot Password?</a>--}}
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button href="/" class="btn btn-lg btn-block btn-light lift text-uppercase">@lang('site.login')</button>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
