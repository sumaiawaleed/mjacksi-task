...
@section('content')
                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal"
                                    data-bs-target="#create-model"><i class="fa-circle-plus me-2 fs-6"></i>@lang('site.add') @lang('site.one_notes')
                            </button>
                        </div>
                    </div>
                </div>
    ...
    @include('dashboard.notes.create_model')
    @include('dashboard.notes.edit_model')
@endsection
@push('styles')
